...
class uint16_t_2d_m
{
    public:
        ...
        std::vector<uint16_t> *mult(const std::vector<uint16_t> &B);
...
class uint32_t_2d_m
{
    public :
        ...
        std::vector<uint32_t> *mult(std::vector<uint32_t> *B);
...
class uint64_t_2d_m
{
    public:
        ...
        std::vector<uint64_t> *mult(std::vector<uint64_t> *B);
...
class float_2d_m
{
    public:
        ...
        std::vector<float> *mult(std::vector<float> *B);
